        ...
        if (e.getSource() == sub) {
            if (term.isSelected()) {
                 Register obj=null;
                    ...
                    obj=new Register( tname.getText(),temail.getText(), tmno.getText(),(String) date.getSelectedItem()+ "."+month.getSelectedItem()+"."+year.getSelectedItem(), tadd.getText(),tpass.getText());
